...
if (!defined('EXTRA_CURL_SECURITY') || EXTRA_CURL_SECURITY !== true) {
    $recommendations[] = [
        ...
        'text' => 'Extra cURL security is not enabled. This setting forces SSL certificate verification for all outbound HTTPS connections, protecting against man-in-the-middle attacks. Note: This may cause issues on localhost or with self-signed certificates.',
        'link_text' => 'View Configuration',
